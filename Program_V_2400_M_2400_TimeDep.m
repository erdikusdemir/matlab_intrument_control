function varargout = Program_V_2400_M_2400_TimeDep(varargin)
% PROGRAM_V_2400_M_2400_TIMEDEP MATLAB code for Program_V_2400_M_2400_TimeDep.fig
%      PROGRAM_V_2400_M_2400_TIMEDEP, by itself, creates a new PROGRAM_V_2400_M_2400_TIMEDEP or raises the existing
%      singleton*.
%
%      H = PROGRAM_V_2400_M_2400_TIMEDEP returns the handle to a new PROGRAM_V_2400_M_2400_TIMEDEP or the handle to
%      the existing singleton*.
%
%      PROGRAM_V_2400_M_2400_TIMEDEP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PROGRAM_V_2400_M_2400_TIMEDEP.M with the given input arguments.
%
%      PROGRAM_V_2400_M_2400_TIMEDEP('Property','Value',...) creates a new PROGRAM_V_2400_M_2400_TIMEDEP or raises the
%      existing singleton*.  Starting Potential the left, property value pairs are
%      applied to the GUI before Program_V_2400_M_2400_TimeDep_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Program_V_2400_M_2400_TimeDep_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Program_V_2400_M_2400_TimeDep

% Last Modified by GUIDE v2.5 03-Dec-2014 14:11:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Program_V_2400_M_2400_TimeDep_OpeningFcn, ...
                   'gui_OutputFcn',  @Program_V_2400_M_2400_TimeDep_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Program_V_2400_M_2400_TimeDep is made visible.
function Program_V_2400_M_2400_TimeDep_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Program_V_2400_M_2400_TimeDep (see VARARGIN)

% Choose default command line output for Program_V_2400_M_2400_TimeDep
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Program_V_2400_M_2400_TimeDep wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs Potential this function are returned to the command line.
function varargout = Program_V_2400_M_2400_TimeDep_OutputFcn(hObject, eventdata, handles) 
...
%Measure2182=visa('ni','GPIB0::3::INSTR');
%fopen(Measure2182);
fopen(Source2400);
...
fprintf(Source2400,':SENS:CURR:RANG:UPP 1.0e-9');
fprintf(Source2400,':SENS:CURR:PROT 1e-6');
...
% 
% fprintf(Measure2182,':VOLT:RANG 2')
...
for i=1:sure
    MeasuredCurrent=0;
        ...
        MeasuredCurrent=ScannedData(2,1);
...
pause(0.01);
   ...
   % set(handles.Resistance,'String',Resistance);
    ...
    grid(handles.Graph1)
    xlabel('Time (Seconds)'),ylabel('Measured Current (A)')
end
