function varargout = Program_V_2400_M_2400_G_236(varargin)
% PROGRAM_V_2400_M_2400_G_236 MATLAB code for Program_V_2400_M_2400_G_236.fig
%      PROGRAM_V_2400_M_2400_G_236, by itself, creates a new PROGRAM_V_2400_M_2400_G_236 or raises the existing
%      singleton*.
%
%      H = PROGRAM_V_2400_M_2400_G_236 returns the handle to a new PROGRAM_V_2400_M_2400_G_236 or the handle to
%      the existing singleton*.
%
%      PROGRAM_V_2400_M_2400_G_236('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PROGRAM_V_2400_M_2400_G_236.M with the given input arguments.
%
%      PROGRAM_V_2400_M_2400_G_236('Property','Value',...) creates a new PROGRAM_V_2400_M_2400_G_236 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Program_V_2400_M_2400_G_236_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Program_V_2400_M_2400_G_236_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Program_V_2400_M_2400_G_236

% Last Modified by GUIDE v2.5 27-Nov-2014 17:36:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Program_V_2400_M_2400_G_236_OpeningFcn, ...
                   'gui_OutputFcn',  @Program_V_2400_M_2400_G_236_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Program_V_2400_M_2400_G_236 is made visible.
function Program_V_2400_M_2400_G_236_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Program_V_2400_M_2400_G_236 (see VARARGIN)

% Choose default command line output for Program_V_2400_M_2400_G_236
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Program_V_2400_M_2400_G_236 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Program_V_2400_M_2400_G_236_OutputFcn(hObject, eventdata, handles) 
...
fprintf(Source2400,':SENS:CURR:PROT 1e-3');
...
AppliedPotential=Vmaster;
    SendPot=sprintf(':SOUR:VOLT 0.001');
    fprintf(Source2400,SendPot);
    
    SendPotGate=sprintf('B%f,0,0X',From);
    fprintf(GateSource,SendPotGate);
     fprintf(GateSource,'H0X');
     fprintf(GateSource,'N1X');

for i=1:NumberofStep
tic
    GatePotential=From+(i-1)*StepSize;
    SendPotGate=sprintf('B%f,0,0X',GatePotential);
    fprintf(GateSource,SendPotGate);
    fprintf(GateSource,'HOX');
